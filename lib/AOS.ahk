...
class UserInterface
{
	class PlayerManager
	{
		...
		NewPlayer()
		{
			shared_options := "y30 x+10"
			Gui, NewPlayer: Add, Text, x10 y10, % "Client:"
			Gui, NewPlayer: Add, Text, x+80 y10, % "Username:"
			Gui, NewPlayer: Add, Text, x+80 y10, % "Email/Login:"
			Gui, NewPlayer: Add, Text, x+80 y10, % "Password:"
			Gui, NewPlayer: Add, Text, y10, % "Pin:"
			Gui, NewPlayer: Add, ComboBox, x10 y+5 w80, RuneLite||Official
			Gui, NewPlayer: Add, Edit, x50 w80, Optional
		...
		Start()
		{
			...
			SetButtonF(AddPlayer, "UserInterface.PlayerManager.NewPlayer")
